class DrinkingWaterApplication {
  String dtl_drink_wat_id = '';
  ...
  DrinkingWaterApplication(
      this.dtl_drink_wat_id,
      this.applicant_name,
      this.mob_no,
      this.district_id,
      this.taluka_id,
  ...
  DrinkingWaterApplication.fromJson(Map<String, dynamic> json) {
   // dtl_drink_wat_id = json['dtl_drink_wat_id'];
    ...
    problem_description_id = json['problem_description_id'];
  ...
  Map<String, dynamic> toJson() {
    ...
    //data['dtl_drink_wat_id'] = this.dtl_drink_wat_id;
    ...
    data['problem_description_id'] = this.problem_description_id;
    data['village_id'] = this.village_id;
