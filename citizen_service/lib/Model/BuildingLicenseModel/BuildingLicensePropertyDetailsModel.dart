class BuildingLicensePropertyDetailsModel {
  String dft_bldg_lic_prop_dtl_id = '';
  String district_id = '';
  String tp_id = '';
  String gp_id = '';
  String village_id = '';
  ...
  BuildingLicensePropertyDetailsModel(
      {required this.dft_bldg_lic_prop_dtl_id,
  ...
  BuildingLicensePropertyDetailsModel.fromJson(Map<String, dynamic> json) {
 //   dft_bldg_lic_prop_dtl_id = json['dft_bldg_lic_prop_dtl_id'];
  ...
  Map<String, dynamic> toJson() {
   ...
   // data['dft_bldg_lic_prop_dtl_id'] = this.dft_bldg_lic_prop_dtl_id;
