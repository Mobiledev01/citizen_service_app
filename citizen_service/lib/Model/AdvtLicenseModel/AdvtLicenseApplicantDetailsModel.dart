class AdvtLicenseApplicantDetailsModel {
  String dft_advt_lic_appl_dtl_id = '';
  String appl_name = '';
  String family_id = '';
  ...
  AdvtLicenseApplicantDetailsModel(
      {required this.dft_advt_lic_appl_dtl_id,
  ...
  AdvtLicenseApplicantDetailsModel.fromJson(Map<String, dynamic> json) {
   // dft_advt_lic_appl_dtl_id = json['dft_advt_lic_appl_dtl_id'];
 ...
 //   data['dft_advt_lic_appl_dtl_id'] = this.dft_advt_lic_appl_dtl_id;
