class AdvtLicenseDocumentDetailsModel {
  String dft_advt_lic_upload_id = '';
  String trn_doc_id = '';
  String doc_id = '';
  String doc_type = '';
  String doc_desc = '';
  ...
  AdvtLicenseDocumentDetailsModel(
      {required this.dft_advt_lic_upload_id,
  ...
  AdvtLicenseDocumentDetailsModel.fromJson(Map<String, dynamic> json) {
    dft_advt_lic_upload_id = json['dft_advt_lic_upload_id'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['dft_advt_lic_upload_id'] = this.dft_advt_lic_upload_id;
