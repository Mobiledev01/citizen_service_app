class AdvtLicensePropertyDetailsModel {
  String dft_advt_lic_prop_dtl_id = '';
  String district_id = '';
  String tp_id = '';
  String gp_id = '';
  String village_id = '';
  ...
  AdvtLicensePropertyDetailsModel(
      {required this.dft_advt_lic_prop_dtl_id,
  ...
  AdvtLicensePropertyDetailsModel.fromJson(Map<String, dynamic> json) {
    dft_advt_lic_prop_dtl_id = json['dft_advt_lic_prop_dtl_id'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['dft_advt_lic_prop_dtl_id'] = this.dft_advt_lic_prop_dtl_id;
