...
class DCWaterConnectionDocDetailsModel {
 ...
 // MultipartFile? doc_temp;
  ...
  DCWaterConnectionDocDetailsModel(
  ...
  DCWaterConnectionDocDetailsModel.fromJson(Map<String, dynamic> json) {
