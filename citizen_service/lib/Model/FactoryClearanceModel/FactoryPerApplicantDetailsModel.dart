class FactoryPerApplicantDetailsModel {
  String dft_fac_per_appl_id = '';
  String appl_name = '';
  String family_id = '';
  ...
  FactoryPerApplicantDetailsModel(
      {required this.dft_fac_per_appl_id,
  ...
  FactoryPerApplicantDetailsModel.fromJson(Map<String, dynamic> json) {
    // dft_fac_per_appl_id = json['dft_fac_per_appl_id'];
  ...
  Map<String, dynamic> toJson() {
    ...
    // data['dft_fac_per_appl_id'] = this.dft_fac_per_appl_id;
