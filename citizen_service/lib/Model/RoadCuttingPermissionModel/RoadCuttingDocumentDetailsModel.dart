class RoadCuttingDocumentDetailsModel {
  String dft_dtl_road_cut_upload_id = '';
  String doc_id = '';
  String doc_name = '';
  String folder_name = '';
  ...
  RoadCuttingDocumentDetailsModel(
      {required this.dft_dtl_road_cut_upload_id,
  ...
  RoadCuttingDocumentDetailsModel.fromJson(Map<String, dynamic> json) {
   // dft_dtl_road_cut_upload_id = json['dft_dtl_road_cut_upload_id'];
    doc_id = json['doc_id'];
  ...
  Map<String, dynamic> toJson() {
   ...
   // data['dft_dtl_road_cut_upload_id'] = this.dft_dtl_road_cut_upload_id;
