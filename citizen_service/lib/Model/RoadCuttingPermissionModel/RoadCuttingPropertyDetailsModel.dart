class RoadCuttingPropertyDetailsModel {
  String dft_dtl_road_cut_prop_id = '';
  String district_id = '';
  String tp_id = '';
  String gp_id = '';
  String village_id = '';
  ...
  RoadCuttingPropertyDetailsModel(
      {required this.dft_dtl_road_cut_prop_id,
      required this.district_id,
      required this.tp_id,
      required this.gp_id,
      required this.village_id,
        required this.req_for,
  ...
  RoadCuttingPropertyDetailsModel.fromJson(Map<String, dynamic> json) {
  //  dft_dtl_road_cut_prop_id = json['dft_dtl_road_cut_prop_id'];
    district_id = json['district_id'];
    tp_id = json['tp_id'];
    gp_id = json['gp_id'];
    village_id = json['village_id'];
    req_for = json['req_for'];
  ...
  Map<String, dynamic> toJson() {
   ...
   // data['dft_dtl_road_cut_prop_id'] = this.dft_dtl_road_cut_prop_id;
    data['district_id'] = this.district_id;
    data['tp_id'] = this.tp_id;
    data['gp_id'] = this.gp_id;
    data['village_id'] = this.village_id;
    data['req_for'] = this.req_for;
