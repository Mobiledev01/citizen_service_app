class VillageSanitationApplication {
  String dtl_village_sant_id = '';
  ...
  VillageSanitationApplication.fromJson(Map<String, dynamic> json) {
    // dtl_village_sant_id = json['dtl_village_sant_id'];
  ...
  Map<String, dynamic> toJson() {
   ...
   // data['dtl_village_sant_id'] = this.dtl_village_sant_id;
